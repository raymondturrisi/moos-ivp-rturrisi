...
/*   FILE: OdometryUUV_Info.cpp                                 */
/*   CIRCA: Spring 2023                                         */
/****************************************************************/

#include <cstdlib>
#include <iostream>
#include "OdometryUUV_Info.h"
...
void showSynopsis()
{
  blk("SYNOPSIS:                                                       ");
  blk("------------------------------------                            ");
  blk("  The pOdometryUUV application is used for               ");
  blk("                                                                ");
  blk("                                                                ");
  blk("                                                                ");
  blk("                                                                ");
...
void showHelpAndExit()
{
  blk("                                                                ");
  blu("=============================================================== ");
  blu("Usage: pOdometryUUV file.moos [OPTIONS]                   ");
  blu("=============================================================== ");
  blk("                                                                ");
  showSynopsis();
  blk("                                                                ");
...
{
  showReleaseInfo("pOdometryUUV", "gpl");
  exit(0);
}
